...
<h2 class="title"> <span class="red"> Introduction </span> to <code class="remark-inline-code">R</code>: Modling Data and Saving Results</h2>
...
<ol>
  <li> Comma-seprated values (<code class="remark-inline-code">read.csv, readr::read_csv</code>)</li>
  <li> Comma-seprated values (<code class="remark-inline-code">readxl::read_excel</code>)</li>
</ol>
...
```
<excercise>Read this file using <code class="remark-inline-code">read.csv</code> and assign this to object <code class="remark-inline-code">cas01</code><br>
<excercise>Read this file using <code class="remark-inline-code">read_csv</code> and assign this to object <code class="remark-inline-code">cas02</code><br>
...
```
<excercise>Read this file using <code class="remark-inline-code">read_excel</code> and assign this to object <code class="remark-inline-code">cas03</code><br>
