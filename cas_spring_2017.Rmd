...
<ol>
  ...
  <li> So what is the right tool to apply these <i>unbeatable anaytical skills</i>?</li>
  <ol>
...
<ol>
  ...
  <li> <code class="remark-inline-code">R</code> is available as Free Software under the terms of the Free Software Foundationâs GNU General Public License in source code form.</li>
</ol>
